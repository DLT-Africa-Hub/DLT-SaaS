  ...
  return (
    <ScrollReveal id="expertise" className='scroll-mt-[100px] pt-[86px]  pb-[150px] md:py-[150px]  flex flex-col items-center gap-[46px] font-sf' direction="up">
        ...
        <div className='px-5 md:px-0 md:flex md:flex-row items-center gap-[50px]'>
          <div className='w-full max-w-[570px] gap-[30px] md:gap-0 h-[545px] flex flex-col items-left justify-between'>
              {expertise.map((exp) => (
                  <div className='h-auto flex justify-start gap-[18px] md:gap-[23px] w-full rounded-r-[20px] py-5 pl-[30px] pr-[10px] border-l-2 border-green-600 bg-linear-to-r from-[#0F0F0F] from-70% to-[#75757559]'>
